...
tab_master <- read_master_idx("day2/sec/master_2022_QTR1.idx")
tab_master
```
...
# Example usage:
# Assuming `master_df` is the dataframe obtained from Task 2
# download_full_submission_file(master_df, "1000045", "2022")
